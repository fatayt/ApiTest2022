 ...
 */
    ...
    public void Get11(){
        ...
        //4. Assertion yap
        //1.yol:
        response.then().statusCode(200).body("meta.pagination.total", equalTo(3370),
        "meta.pagination.links.current", equalTo("https://gorest.co.in/public/v1/users?page=1"),
        "data.id", hasSize(10), "data.status", hasItem("active"),
        "data.name", hasItems("Kali Prajapat","Dipali Bhattathiri","Aatmaj Chopra"));
        //2.yol JsonPath kullanalim
        JsonPath json = response.jsonPath();
//        assertEquals(3370, json.getInt("meta.pagination.total"));
